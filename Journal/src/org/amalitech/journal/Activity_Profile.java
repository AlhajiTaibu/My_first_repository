...
public class Activity_Profile extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// Setting the view of the profile_layout
			...
			public boolean onTouch(View v, MotionEvent event) {
				...
				switch (event.getActionMasked()){
  						...
  						case MotionEvent.ACTION_POINTER_UP: {
  							...
  							//do the action
  							Intent activity_MainNewsPage_intent = new Intent(Activity_Profile.this, Activity_MainNewsPage.class );
	...
	public TextView nav_TV(int total_num_i, String prefix_str, int tv_i){
		...
		int textView_tv_ID = ctx.getResources().getIdentifier(textView_tv_ids[tv_i], "id", "org.amalitech.journal");
	...
	public View nav_V(int total_num_i, String prefix_str, int v_i){
		...
		int view_ID = ctx.getResources().getIdentifier(view_ids[v_i], "id", "org.amalitech.journal");
